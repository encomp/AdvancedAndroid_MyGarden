...
public class PlantWateringService extends IntentService {
  ...
  /**
   * Starts this service to perform UpdatePlantWidgets action with the given parameters. If the
  ...
  private void handleActionUpdatePlantWidgets() {
    ...
    Cursor cursor =
        getContentResolver()
            .query(PLANT_URI, null, null, null, PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME);
    ...
    if (cursor != null && cursor.getCount() > 0) {
      ...
      cursor.close();
      canWater =
          (timeNow - wateredAt) > PlantUtils.MIN_AGE_BETWEEN_WATER
              && (timeNow - wateredAt) < PlantUtils.MAX_AGE_WITHOUT_WATER;
      imgRes =
          PlantUtils.getPlantImageRes(this, timeNow - createdAt, timeNow - wateredAt, plantType);
    }
    ...
    PlantWidgetProvider.updatePlantWidgets(
        this, appWidgetManager, imgRes, plantId, canWater, appWidgetIds);
  }
}
