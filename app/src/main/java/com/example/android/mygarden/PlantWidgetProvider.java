...
public class PlantWidgetProvider extends AppWidgetProvider {
  ...
  static void updateAppWidget(
      Context context, AppWidgetManager appWidgetManager, int imageRes, int appWidgetId) {
  ...
  static void updatePlantWidgets(
      Context context, AppWidgetManager appWidgetManager, int imageRes, int[] appWidgetIds) {
